...
public struct AnimationDirection {
    ...
    public init(_  duration: TimeInterval, _ isForward: Bool) {
...
public final class CornerRadiusAnimation : ValueAnimationCompatible {
    ...
    public func animate(_ animationDirection: AnimationDirection) {
        if #available(iOS 11.0, *) {
            ...
            animation.fromValue = animationDirection.isForward ? self.fromValue : self.toValue
            animation.toValue = animationDirection.isForward ? self.toValue : self.fromValue
            animation.isRemovedOnCompletion = true
            self.view.layer.add(animation, forKey: "cornerRadius")
            self.view.layer.cornerRadius = animationDirection.isForward ? self.toValue : self.fromValue
        }
    }
...
public class CustomAnimation : AnimationCompatible {
    ...
    public func finishAnimation(_ isForward: Bool, _ didComplete: Bool) {
        self.finish?(isForward, didComplete)
    }
}
